...
import com.labs.okey.oneride.advsettings.LocalLinkAdvSettingsFragment;
...
public class AdvSettingsActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch ( position ) {
                case 0 : // Local-link
                    return LocalLinkAdvSettingsFragment.getInstance();

                case 1:
                    return OpenCVAdvSettingsFragment.getInstance();
            }
