package com.labs.okey.oneride.views;
...
public class LayoutRipple extends CustomView {
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        // Color by resource
        int background = attrs.getAttributeResourceValue(ANDROIDXML,
                "background", -1);
        if (background != -1) {
        ...
        if (rippleColor != -1) {
            ...
            // Color by hexadecimal
            int _background = attrs.getAttributeIntValue(MATERIALDESIGNXML, "rippleColor", -1);
            if (_background != -1)
                setRippleColor(_background);
            else
